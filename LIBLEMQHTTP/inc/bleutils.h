...
#define BT_REMOTE_DEVICE_NAME 		"TIZENSOR"
#define BT_REMOTE_DEVICE_ADDRESS 	"66:92:47:E2:5D:08" /* ONLY FOR TEST PURPOSES*/
#define BT_REMOTE_DEVICE_ADDRESS_2 	"41:A1:CC:C0:C4:87" /* ONLY FOR TEST PURPOSES*/
